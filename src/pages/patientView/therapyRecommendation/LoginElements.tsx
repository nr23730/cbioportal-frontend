    ...
    public render() {
        ...
        return (
            ...
            >
                ...
                <Modal.Footer>
                    <Button type="button" bsStyle="link" onClick={this.openInTab}>
                        Open in new tab
                    </Button>
                    <Button type="button" bsStyle="primary" onClick={this.props.handleClose}>
                        Close
                    </Button>
                </Modal.Footer>
            </Modal>
...
export class UserInfoButton extends React.Component<
    IUserInfoButtonProps,
    {}
> {
    ...
    private logout() {
        ...
        request
            .get(logoutUrl)
            .then( () => {this.props.checkPermission();} )
            .catch(err => {
