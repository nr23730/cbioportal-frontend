...
export default class TherapyRecommendationFormDrugInput extends React.Component<TherapyRecommendationFormDrugInputProps, {}> {
  ...
  public render() {
    ...
    const drugDefault = this.props.data.treatments.map((drug:ITreatment) => 
    ({
      value: drug, 
      label: drug.name
    }));
